...
BLOG_AUTHOR = "Mike Jarrett"  # (translatable)
BLOG_TITLE = "Mike Jarrett"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://notes.mikejarrett.ca/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://notes.mikejarrett.ca/"
BLOG_EMAIL = "mike@mikejarrett.ca"
BLOG_DESCRIPTION = "Mike Jarrett's Blog"  # (translatable)
...
#     # 'site': '@website',         # twitter nick for the website
      'creator': '@mikejarrett_',     # Username for the content creator / author.
 }
